...
test('TC 2', (done) => {
  const filePath = path.resolve(__dirname, '../cars.JSON');
  let child = spawn('node', ['./carhub.js', 'carhub a', filePath]);
...
test('TC 3', (done) => {
  let child = spawn('node', ['./carhub.js', 'carhub add']);
...
test('TC 4', (done) => {
  let filePath = path.resolve(__dirname, 'cars.txt');
  let child = spawn('node', ['./carhub.js', 'carhub list', filePath]);
...
test('TC 5', (done) => {
  let child = spawn('node', ['./carhub.js', 'carhub help']);
